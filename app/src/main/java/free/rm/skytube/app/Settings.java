...
public class Settings {
    ...
    public boolean isBlockerToolbarIconVisible() {
        return getPreference(R.string.pref_key_show_blocker_toolbar_icon, false);
    }
    ...
    public boolean isChannelAllowListEnabled() {
        final String channelFilter = getPreference(R.string.pref_key_channel_filter_method,
                getStr(R.string.channel_blacklisting_filtering));
        return channelFilter.equals(getStr(R.string.channel_whitelisting_filtering));
    }

    public boolean isSubscribedChannelsOnlyEnabled() {
        final String channelFilter = getPreference(R.string.pref_key_channel_filter_method,
                getStr(R.string.channel_blacklisting_filtering));
        return channelFilter.equals(getStr(R.string.channel_subscriptions_filtering));
    }

    public boolean isFilterSearchChannelResultsEnabled() {
        return getPreference(R.string.pref_key_filter_search_channel_results, false);
    }

    public boolean isFilterSearchPlaylistResultsEnabled() {
        return getPreference(R.string.pref_key_filter_search_playlist_results, false);
    }
