...
public class SkyTubeApp extends MultiDexApplication {
	...
	public void onCreate() {
		...
		skyTubeApp = this;
		TLSSocketFactory.installCompatIfNeeded();
		TLSSocketFactory.logRuntimeSummary();
	...
	private void installCrashFileLogger() {
		final Thread.UncaughtExceptionHandler previousHandler = Thread.getDefaultUncaughtExceptionHandler();
		Thread.setDefaultUncaughtExceptionHandler((thread, throwable) -> {
			DiagnosticFileLogger.appendCrash(DiagnosticFileLogger.buildCrashEntry(thread, throwable));
