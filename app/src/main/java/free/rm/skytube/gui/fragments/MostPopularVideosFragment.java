...
public class MostPopularVideosFragment extends VideosGridFragment {
	private boolean refreshOnNextSelection;

	@Override
	public void onFragmentSelected() {
		super.onFragmentSelected();
		if (refreshOnNextSelection && videoGridAdapter != null) {
			videoGridAdapter.refresh(true);
		}
		refreshOnNextSelection = false;
	}
	...
	void refreshAfterNextExplicitTabSelection() {
		refreshOnNextSelection = true;
	}
