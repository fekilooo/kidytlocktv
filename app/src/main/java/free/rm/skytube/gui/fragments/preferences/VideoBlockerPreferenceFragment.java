...
public class VideoBlockerPreferenceFragment extends BasePreferenceFragment {
	...
	protected void showPreferencesInternal(String rootKey) {
		...
		final Preference searchChannelResultsPreference = findPreference(getString(R.string.pref_key_filter_search_channel_results));
		final Preference searchPlaylistResultsPreference = findPreference(getString(R.string.pref_key_filter_search_playlist_results));

		// enable/disable the video blocker
		initChannelFilteringPreferences(channelBlacklistPreference, channelWhitelistPreference,
				searchChannelResultsPreference, searchPlaylistResultsPreference);
		...
		findPreference(getString(R.string.pref_key_filter_search_channel_results)).setOnPreferenceChangeListener(settingUpdatesPreferenceChange);
		findPreference(getString(R.string.pref_key_filter_search_playlist_results)).setOnPreferenceChangeListener(settingUpdatesPreferenceChange);
	...
	private void initChannelFilteringPreferences(Preference channelBlacklistPreference, Preference channelWhitelistPreference,
												 Preference searchChannelResultsPreference, Preference searchPlaylistResultsPreference) {
	...
	private void initChannelFilteringPreferences(String channelFilter, Preference channelBlacklistPreference,
												 Preference channelWhitelistPreference, Preference searchChannelResultsPreference,
												 Preference searchPlaylistResultsPreference) {
		if (channelFilter.equals(getString(R.string.channel_blacklisting_filtering))) {
			...
			searchChannelResultsPreference.setEnabled(false);
			searchPlaylistResultsPreference.setEnabled(false);
			...
			searchChannelResultsPreference.setEnabled(false);
			searchPlaylistResultsPreference.setEnabled(false);
		} else if (channelFilter.equals(getString(R.string.channel_subscriptions_filtering))) {
			channelBlacklistPreference.setEnabled(false);
			channelWhitelistPreference.setEnabled(false);
			searchChannelResultsPreference.setEnabled(true);
			searchPlaylistResultsPreference.setEnabled(true);
		} else {
