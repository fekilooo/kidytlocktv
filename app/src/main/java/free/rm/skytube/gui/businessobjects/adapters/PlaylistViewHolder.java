...
class PlaylistViewHolder extends RecyclerView.ViewHolder {
	...
	void setPlaylist(final YouTubePlaylist playlist) {
		...
		View.OnClickListener openPlaylist = view -> playlistClickListener.onClickPlaylist(playlist);
		binding.getRoot().setOnClickListener(openPlaylist);
		binding.thumbnailImageView.setOnClickListener(openPlaylist);
	}
}
