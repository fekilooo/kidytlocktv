...
public class SubscriptionsVideosTable {
    ...
    static {
        ...
        s.append(" from subscription_videos s")
                .append(" inner join Subs current_sub on current_sub.channel_pk = s.channel_pk")
                .append(" left join Channel c on s.channel_pk = c._id ");
