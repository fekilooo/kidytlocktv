...
public class PlaybackStatusTable {
	...
	public static final String COL_LAST_PLAYED_TS = "Last_Played_TS";
	...
	public static String getCreateStatement() {
		return "CREATE TABLE " + TABLE_NAME + " (" +
						...
						COL_LAST_PLAYED_TS + " INTEGER " +
						" )";
	}

	public static String getAddVideoColumn() {
		return "ALTER TABLE " + TABLE_NAME + " ADD COLUMN " + COL_YOUTUBE_VIDEO + " BLOB";
	}

	public static String getAddLastPlayedColumn() {
		return "ALTER TABLE " + TABLE_NAME + " ADD COLUMN " + COL_LAST_PLAYED_TS + " INTEGER";
	}
}
