...
public class YouTubePlaylist extends CardData implements Serializable {
	...
	public YouTubePlaylist(String id, String title, String description, Long publishDate, long videoCount, String thumbnailUrl, YouTubeChannel channel) {
		this(id, id, title, description, publishDate, videoCount, thumbnailUrl, channel);
	}

	public YouTubePlaylist(String id, String sourceUrl, String title, String description, Long publishDate, long videoCount, String thumbnailUrl, YouTubeChannel channel) {
		this.id = id;
	...
	public String getSourceUrl() {
		return sourceUrl != null ? sourceUrl : id;
	}
