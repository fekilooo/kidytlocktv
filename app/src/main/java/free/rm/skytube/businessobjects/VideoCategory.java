...
import free.rm.skytube.businessobjects.YouTube.CombinedSearchVideos;
...
import free.rm.skytube.businessobjects.YouTube.TrendingVideosWithSubscriptions;
import free.rm.skytube.businessobjects.bilibili.BilibiliPopularVideos;
...
public enum VideoCategory {
	...
	public GetYouTubeVideos createGetYouTubeVideos() {
		switch (this) {
            ...
            case MOST_POPULAR: return new TrendingVideosWithSubscriptions();
			case SEARCH_QUERY: return new CombinedSearchVideos();
			...
			case BILIBILI_POPULAR: return new BilibiliPopularVideos();
